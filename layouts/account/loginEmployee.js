...
export default function LogInEmployee({ navigation }) {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post("http://192.168.100.14:8080/loginTrabajador", empleado);
      ...
      if (response.status === 200 && response.data) {
        ...
        navigation.navigate("EmployeeMain", { usuarioRegistrado: usuarioData });  // Asegúrate de que "EmployeeMain" es el nombre correcto de tu pantalla de inicio
      } else {
