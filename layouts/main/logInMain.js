    ...
    return (
      ...
      <ScrollView>
        ...
        <View style= {styles.container} onLayout={onLayout} >
          ...
          <Text style= {styles.mainText}>Elige tu tipo de usuario e ingresa</Text>
        </View>
        
        <View style={styles.secondContainer}>
            
            <TouchableOpacity style={styles.button2} mode="contained" onPress={() => navigation.navigate('LogInEmployer')}><Text style={styles.buttonText}>Empleador</Text></TouchableOpacity>       
              
        </View>
        <View style={styles.secondContainer}>
            
            <TouchableOpacity style={styles.button2} mode="contained" onPress={() => navigation.navigate('LogInEmployee')}><Text style={styles.buttonText}>Trabajador</Text></TouchableOpacity>         
        </View>
        <View style={{ marginTop: 20, flexDirection: 'row', alignItems: 'center', alignSelf: 'center' }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("SignUpMain")}>
            <Text style={{ color: '#03045E', fontWeight: '600', fontSize: 14 }}>Registrarte</Text>
          </TouchableOpacity>
        </View>
